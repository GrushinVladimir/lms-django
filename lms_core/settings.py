...
SECRET_KEY = 'django-insecure-*@tgt21=y8l-!+m$^)2xjj60qti#o$t9zmbdi%pn%98==$oy6d'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'im',         # Имя вашей БД
        'USER': 'postgres',       # Пользователь
        'PASSWORD': 'admin',  # Пароль
        'HOST': 'localhost',      # Если БД на локальной машине
